...
- Vercel hosting and PWA install support
...
The app includes a manifest, theme color, placeholder icons, safe-area spacing utilities, and an app shell designed for installable mobile use. Service worker generation is handled by `next-pwa` during production builds.
